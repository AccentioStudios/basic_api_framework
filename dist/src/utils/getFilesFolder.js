    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    files = (_a.sent())
                        .filter(function (dirent) { return dirent.isFile(); }).map(function (dirent) { return dirent.name; });
                    return [4 /*yield*/, files.forEach(function (file) { return __awaiter(_this, void 0, void 0, function () {
                            var _module, object;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, ignore.forEach(function (ignoreItem) {
                                            if (file.includes(ignoreItem)) {
                                                return;
                                            }
                                        })];
                                    case 1:
                                        _a.sent();
                                        if (!(path.extname(file) === ".".concat(ext))) return [3 /*break*/, 3];
